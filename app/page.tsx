...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-[#082725] text-[#f3f0e5]">
      ...
      {/* ABOUT & PLATFORM HIGHLIGHTS SECTION */}
      <section id="about" className="bg-[#f3f0e5] px-6 py-24 text-[#153b32] sm:px-12 lg:px-20">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            {/* HIGH-END GLASSMORPHIC LIVE OPERATIONS SHOWCASE CARD */}
            <div className="relative overflow-hidden rounded-3xl border border-[#153b32]/20 bg-[#082725] p-8 text-[#f3f0e5] shadow-2xl backdrop-blur-xl">
              <div className="absolute -right-16 -top-16 size-48 rounded-full bg-[#d7f36b]/10 blur-3xl" />
              
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 rounded-full border border-[#d7f36b]/30 bg-[#d7f36b]/10 px-3.5 py-1 font-mono text-xs font-bold uppercase tracking-[0.2em] text-[#d7f36b]">
                  <Sparkles className="size-3.5" /> Smart Operations Engine
                </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-md text-base leading-relaxed text-white/80">
                Have questions about SocietySync or society onboarding? Reach out to our management team directly.
              </p>
              ...
              <div className="mt-8 flex flex-col gap-4">
                <div className="flex items-center gap-4 rounded-2xl border border-white/15 bg-white/5 p-4 backdrop-blur-xl shadow-md">
                  ...
                  <div>
                    <p className="text-xs font-mono uppercase tracking-wider text-white/60">Location / Head Office</p>
